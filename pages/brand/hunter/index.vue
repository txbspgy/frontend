<template>
  <main>
    ...
    <section class="px-20">
      <div class="container p-4 bg-white dark:bg-gray-800 mx-auto sm:px-6 lg:px-8 relative py-2">
        <div class="relative">
          <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div class="lg:col-start-2 lg:max-w-2xl ml-auto">
              <p class="text-base leading-6 text-indigo-500 font-semibold uppercase">互相帮助</p>
              <h4
              ...
              <p class="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
                为您的所有团队构建一个简单而强大的协作空间。跟踪，共享，衡量，您拥有完全的控制权，这从来都不是简单而有效的。
              </p>
